	...
	public class AliH5Pay
	{
		public static void sendPost()
		{
			...
			*/
			...
			string callBack = "http://****/h5/callback";
			...
			dataDic.Add("returnURL", returnURL);//returnURL
			...
			dataDic.Add("terminalType", terminalType);//terminalType
			dataDic.Add("tradeIP", tradeIP);//tradeIP
